...
CREATE TABLE `medications` (
  ...
  KEY `FKc2gnonyv0fynih7tkrre0m46x` (`patient_id`),
  CONSTRAINT `FKc2gnonyv0fynih7tkrre0m46x` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patients` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK8nemyvjmv4lcoy8ons5bldmer` (`contact`)
...
INSERT INTO `patients` VALUES (1,'9876543210','Pre-Diabetes, Hypertension','Anitha Arun'),(2,'9131789745','Anxiety','Bhavika B'),(3,'745817165','Depression','Kumaranna katte'),(5,'8765432109','Knee Pain','Gambika');
...
-- Dump completed on 2025-03-02 13:14:18
